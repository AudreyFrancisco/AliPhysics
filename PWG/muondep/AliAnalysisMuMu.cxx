...
//_____________________________________________________________________________
AliAnalysisMuMuSpectra* AliAnalysisMuMu::FitParticle(const char* particle,const char* trigger,const char* eventType,const char* pairCut,const char* centrality,const AliAnalysisMuMuBinning& binning,Bool_t corrected,Bool_t SP,const TString* fitMethod,const char* flavour,const char* histoType)
{
/**
...
//add sfittype if necessary fitType->String()
